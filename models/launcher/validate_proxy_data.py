...
class ValidateProxyData(BaseModel):
    """
    ValidateProxyData
    """ # noqa: E501
    ip: StrictStr
    ...
    altitude: Union[StrictFloat, StrictInt]
    accuracy: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["ip", "timezone", "country_code", "latitude", "longitude", "altitude", "accuracy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidateProxyData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidateProxyData from a dict"""
        if obj is None:
            return None
