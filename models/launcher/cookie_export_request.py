...
class CookieExportRequest(BaseModel):
    ...
    folder_id: StrictStr
    __properties: ClassVar[List[str]] = ["profile_id", "folder_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CookieExportRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CookieExportRequest from a dict"""
        if obj is None:
            return None
