...
class Proxy(BaseModel):
    ...
    Proxy
    """ # noqa: E501
    type: StrictStr = Field(description="url - loads proxy object from remote url provided in host field before browser profile start")
    host: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['http', 'https', 'socks5', 'url']):
            raise ValueError("must be one of enum values ('http', 'https', 'socks5', 'url')")
        return value
