...
class ExportRecord(BaseModel):
    ...
    encryption_key: StrictStr
    __properties: ClassVar[List[str]] = ["export_id", "profile_id", "has_error", "encryption_key"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExportRecord from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExportRecord from a dict"""
        if obj is None:
            return None
