...
class Update2FA(BaseModel):
    """
    Update2FA
    """ # noqa: E501
    enable: StrictBool = Field(description="If set to true enables 2FA, if set to false disables 2FA")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Update2FA from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Update2FA from a dict"""
        if obj is None:
            return None
