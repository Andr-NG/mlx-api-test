...
from models.MLX.profile_info import ProfileInfo
...
class ProfileInfoResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProfileInfoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProfileInfoResponse from a dict"""
        if obj is None:
            return None
