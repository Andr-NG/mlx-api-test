...
class WorkspaceInvitation(BaseModel):
    ...
    WorkspaceInvitation
    """ # noqa: E501
    email: StrictStr = Field(description="Email of the invited user")
    workspace_id: StrictStr = Field(description="Workspace ID to which he was invited")
    role: StrictStr = Field(description="Role of the user in workspace")
    invited_at: datetime = Field(description="Date and Time of invitation sent")
    expires_at: datetime = Field(description="Date and Time of invitation expiration")
    __properties: ClassVar[List[str]] = ["email", "workspace_id", "role", "invited_at", "expires_at"]
