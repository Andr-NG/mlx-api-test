...
class MediaDevices(BaseModel):
    ...
    MediaDevices
    """ # noqa: E501
    video_inputs: StrictInt
    audio_inputs: StrictInt
    audio_outputs: StrictInt
    __properties: ClassVar[List[str]] = ["video_inputs", "audio_inputs", "audio_outputs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "video_inputs": obj.get("video_inputs"),
            "audio_inputs": obj.get("audio_inputs"),
