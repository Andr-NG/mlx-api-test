...
class CreateSingleObjectResponse(BaseModel):
    """
    CreateSingleObjectResponse
    """ # noqa: E501
    status: ResponseStatus
    data: Optional[CreateSingleObject] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CreateSingleObject.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
