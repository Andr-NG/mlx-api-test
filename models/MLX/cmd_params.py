...
class CmdParams(BaseModel):
    ...
    CmdParams
    """ # noqa: E501
    params: Annotated[List[CmdParam], Field(min_length=1, max_length=10)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "params": [CmdParam.from_dict(_item) for _item in obj["params"]] if obj.get("params") is not None else None
        })
        return _obj
