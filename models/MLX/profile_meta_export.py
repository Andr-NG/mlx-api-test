...
class ProfileMetaExport(BaseModel):
    """
    ProfileMetaExport
    """ # noqa: E501
    folder_id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["folder_id", "workspace_id", "status", "created_at", "last_update_at", "removed_at", "removed_by", "is_mla_profile", "browser_type", "os_type", "core_version", "name", "notes", "tags", "parameters", "auto_update_core"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProfileMetaExport from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProfileMetaExport from a dict"""
        if obj is None:
            return None
