...
class FolderUserArray(BaseModel):
    """
    FolderUserArray
    """ # noqa: E501
    total_count: StrictInt
    users: Annotated[List[FolderUser], Field(min_length=1, max_length=100)]
    __properties: ClassVar[List[str]] = ["total_count", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [FolderUser.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
