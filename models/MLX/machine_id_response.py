...
from models.MLX.machine_id_response_data import MachineIDResponseData
...
class MachineIDResponse(BaseModel):
    ...
    data: Optional[MachineIDResponseData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MachineIDResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MachineIDResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": MachineIDResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
