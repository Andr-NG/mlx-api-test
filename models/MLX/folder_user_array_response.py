...
class FolderUserArrayResponse(BaseModel):
    """
    FolderUserArrayResponse
    """ # noqa: E501
    status: ResponseStatus
    data: Optional[FolderUserArray] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": FolderUserArray.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
