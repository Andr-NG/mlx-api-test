...
class VersionResponseData(BaseModel):
    ...
    version: StrictStr
    env: StrictStr
    __properties: ClassVar[List[str]] = ["version", "env"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VersionResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VersionResponseData from a dict"""
        if obj is None:
            return None
