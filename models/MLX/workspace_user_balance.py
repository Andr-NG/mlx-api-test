...
class WorkspaceUserBalance(BaseModel):
    """
    WorkspaceUserBalance
    """ # noqa: E501
    profiles_balance: StrictInt
    members_balance: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["profiles_balance", "members_balance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "profiles_balance": obj.get("profiles_balance"),
            "members_balance": obj.get("members_balance")
        })
        return _obj
