...
class WorkspaceKeyResponseData(BaseModel):
    """
    WorkspaceKeyResponseData
    """ # noqa: E501
    pub: StrictStr = Field(description="Public bas64 encoded key")
    prv: StrictStr = Field(description="Private bas64 encoded key")
    key_type: StrictStr = Field(description="Private key type. Used to determine decription policy. Possible values are 'server_generated', 'client_generated'")
    __properties: ClassVar[List[str]] = ["pub", "prv", "key_type"]
