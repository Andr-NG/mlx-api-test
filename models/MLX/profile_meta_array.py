...
class ProfileMetaArray(BaseModel):
    """
    ProfileMetaArray
    """ # noqa: E501
    profiles: Annotated[List[ProfileMeta], Field(min_length=1, max_length=100)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "profiles": [ProfileMeta.from_dict(_item) for _item in obj["profiles"]] if obj.get("profiles") is not None else None
        })
        return _obj
