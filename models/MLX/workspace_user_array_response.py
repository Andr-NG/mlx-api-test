...
class WorkspaceUserArrayResponse(BaseModel):
    """
    WorkspaceUserArrayResponse
    """ # noqa: E501
    status: ResponseStatus
    data: Optional[WorkspaceUserArray] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": WorkspaceUserArray.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
