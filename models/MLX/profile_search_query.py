...
class ProfileSearchQuery(BaseModel):
    ...
    profiles: Annotated[List[ProfileSearchQueryItem], Field(min_length=1, max_length=50)]
    __properties: ClassVar[List[str]] = ["total_count", "profiles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profiles": [ProfileSearchQueryItem.from_dict(_item) for _item in obj["profiles"]] if obj.get("profiles") is not None else None
        })
        return _obj
