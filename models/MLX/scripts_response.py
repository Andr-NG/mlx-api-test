...
class ScriptsResponse(BaseModel):
    ...
    data: Optional[List[StrictStr]] = Field(default=None, description="List of user scripts paths relative to the scripts folder")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ScriptsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ScriptsResponse from a dict"""
        if obj is None:
            return None
