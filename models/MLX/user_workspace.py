...
class UserWorkspace(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Name of Workspace")
    workspace_id: StrictStr = Field(description="Workspace ID")
    role: StrictStr = Field(description="Role of user in workspace")
    __properties: ClassVar[List[str]] = ["name", "workspace_id", "role"]
