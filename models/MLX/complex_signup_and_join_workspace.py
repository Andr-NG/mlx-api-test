...
class ComplexSignupAndJoinWorkspace(BaseModel):
    """
    ComplexSignupAndJoinWorkspace
    """ # noqa: E501
    creds: UserCreds
    ...
    role: StrictStr
    token: StrictStr
    __properties: ClassVar[List[str]] = ["creds", "settings", "workspace_id", "role", "token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ComplexSignupAndJoinWorkspace from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ComplexSignupAndJoinWorkspace from a dict"""
        if obj is None:
            return None
